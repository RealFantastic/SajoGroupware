...
//	UPDATE_DATE              DATE   
	...
	public String toString() {
		return "EapDomain [ea_no=" + ea_no + ", ea_title=" + ea_title + ", ea_content=" + ea_content + ", draft_id="
				+ draft_id + ", draft_date=" + draft_date + ", first_approver=" + first_approver + ", second_approver="
				+ second_approver + ", third_approver=" + third_approver + ", final_approver=" + final_approver
				+ ", status_code=" + status_code + ", result_code=" + result_code + ", form_code=" + form_code
				+ ", return_reson=" + return_reson + ", update_date=" + update_date + "]";
	}
