...
-- 내가 상신한 문서
SELECT * FROM
    (SELECT EA_NO,EA_TITLE,E.EMP_NAME DRAFTER_NAME,FIRST_APPROVER,SECOND_APPROVER,THIRD_APPROVER,FINAL_APPROVER 
    FROM ELEC_APPROVAL EA
    JOIN EMPLOYEE E ON EA.DRAFTER_ID = E.EMP_NO
    where drafter_id = '202210004') BASE
JOIN (SELECT EA_NO, E.EMP_NAME FST_NAME
        FROM ELEC_APPROVAL EA JOIN EMPLOYEE E ON EA.FIRST_APPROVER = E.EMP_NO WHERE DRAFTER_ID = '202210004') SUB1
ON BASE.EA_NO = SUB1.EA_NO;
