...
INSERT INTO DEPARTMENT VALUES (10, '경영인사팀');
INSERT INTO DEPARTMENT VALUES (20, '영업마케팅팀');
INSERT INTO DEPARTMENT VALUES (30, '회계총무팀');
INSERT INTO DEPARTMENT VALUES (40, '기획개발팀');
update employee set dept_no=10 where emp_no = '200000001';
update employee set dept_no=40 where emp_no = '200500002';
commit;
--사원휴가 추가
...
select * from department left outer join 
  		(select dept_no, emp_no,concat(concat(emp_name,' '),job_name) as emp_name
  		 from employee join job using(job_no) order by job_no desc)
  	using (dept_no)
order by dept_no;
...
--결재 대기 리스트
SELECT info.*,e.emp_name drafter_name, hh.left_count left_count 
FROM view_elec_appr_infos info 
    join employee e on drafter_id = emp_no 
    join holiday_history hh on info.ea_no = hh.ea_no 
WHERE (RESULT_CODE = 0 AND DRAFTER_ID = '199600001')
        OR (RESULT_CODE = 2 AND ( (SECOND_APPROVER = '199600001' ) OR (THIRD_APPROVER = '199600001') OR (FINAL_APPROVER = '199600001') )) 
...
('111-22-33333','(주)참치마요','서비스 및 개발', '서울 특별시 송파구 신천동 29 시그니엘 서울','100층',
05551,'박정환','02-444-5555','1996-07-22');

SELECT EMP_NO FROM EMPLOYEE;



INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,199600001,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,200000001,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,200500002,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,200830001,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,200920005,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201010008,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201140015,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201140017,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201310033,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201330030,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201420042,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201440052,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201530055,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201620068,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201630077,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201710090,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201820102,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201940113,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201940138,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,202030152,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,202110185,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,202220207,15,0,15);
INSERT INTO EMPLOYEE_HOLIDAY VALUES(SEQ_BIRTH_NO.NEXTVAL,2022,201210028,0,0,0);
COMMIT;
...
;
DELETE FROM EMPLOYEE_HOLIDAY WHERE EMP_NO = '202210001';
DELETE FROM ELEC_APPROVAL WHERE DRAFTER_ID = '202210001';
DELETE FROM HOLIDAY_HISTORY WHERE EMP_NO = '202210001';
INSERT INTO EMPLOYEE_HOLIDAY VALUES (SEQ_BIRTH_NO.NEXTVAL,EXTRACT(YEAR FROM SYSDATE),'202210001',15,null,15);
COMMIT;

select substr('2022-AR-017',5,2) from dual;


select
    to_number(nvl(
        (SELECT used_count FROM EMPLOYEE_HOLIDAY WHERE BIRTH_YEAR = EXTRACT(YEAR FROM SYSDATE) AND EMP_NO = '202210001'),0))
from DUAL;

SELECT
(SELECT LEFT_COUNT FROM EMPLOYEE_HOLIDAY 
WHERE BIRTH_YEAR = EXTRACT(YEAR FROM SYSDATE) AND EMP_NO = '202210001')
+ (SELECT hd_count FROM HOLIDAY_HISTORY 
WHERE EA_NO='2022-AR-015')
FROM DUAL;

SELECT * FROM HOLIDAY_HISTORY WHERE EMP_NO = 202210001;
...
-- 검색결과에 맞는 직원별 연차리스트
-- 사원번호, 사원명, 직급명, 부서명, 연락처, 잔여연차
SELECT 
    EMP.EMP_NO EMP_NO,EMP.EMP_NAME EMP_NAME
    ,EMP.PHONE PHONE, NVL(EMP_HOLIDAY.LEFT_COUNT,0) LEFT_COUNT
    , D.DEPT_NAME DEPT_NAME,J.JOB_NAME JOB_NAME
FROM EMPLOYEE EMP
LEFT OUTER JOIN 
    (SELECT * FROM EMPLOYEE_HOLIDAY WHERE BIRTH_YEAR = EXTRACT(YEAR FROM SYSDATE)) EMP_HOLIDAY ON EMP.EMP_NO = EMP_HOLIDAY.EMP_NO
JOIN DEPARTMENT D USING (DEPT_NO)
JOIN JOB J USING (JOB_NO)
--WHERE EMP.EMP_NO LIKE '%2022%'
--WHERE D.DEPT_NAME LIKE '%인%'
WHERE EMP.EMP_NAME LIKE '%김%'
;
...
SELECT EAP.*,FORM.FORM_TITLE,AF.*
    	...
    	JOIN EA_FORM FORM ON EAP.FORM_CODE = FORM.FORM_CODE
    	LEFT OUTER JOIN APPROVAL_FILE AF ON EAP.EA_NO = AF.DOC_NO
    	WHERE DRAFTER_ID = '202210001' and RESULT_CODE = 2
    	ORDER BY DRAFT_DATE DESC;
...
SELECT EMP_NO,PASSWORD,EMP_NAME,EMAIL,PHONE,ADDRESS,HIRE_DATE ,PIC_PATH,PIC_NAME,IS_LEAVE,e.DEPT_NO,d.DEPT_NAME,j.JOB_NO,j.JOB_NAME,CP_NUMBER ,SIGN_PATH,SIGN_FILE_NAME FROM EMPLOYEE e JOIN DEPARTMENT d ON e.DEPT_NO = d.DEPT_NO JOIN JOB j ON e.JOB_NO = j.JOB_NO WHERE EMP_NO='202210001';

select emp_no,password 
from employee 
where emp_no = '199600001';
