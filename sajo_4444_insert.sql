...
--COMMENT_NO	NUMBER	No		1	NVL(MAX(NO),0)+1
--C_WRITER	VARCHAR2(30 BYTE)	No		2	
--C_CONTENT	VARCHAR2(200 BYTE)	No		3	
--C_WRITE_DATE	TIMESTAMP(6)	No	"SYSTIMESTAMP	"	4	
--WORK_NO	NUMBER	No		5	NVL(MAX(NO),0)+1
